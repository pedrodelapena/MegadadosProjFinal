...
Para este e outros fins, existem sites que fornecem serviços de cloud pública, onde um usuário pode executar máquinas virtuais dos mais diversos tipos e configurações em <i>clusters</i>, como é o caso da [Amazon](https://aws.amazon.com/).
